public enum EventGlobal
{
    ...
    E_GetChildDataByGoogleId,
    E_GetChildDataByAppleId,
    ...
    E_StartAutorizationByApple,
    E_StartAutorizationByGoogle,
    ...
    E_OpenedBookCommand,
    E_FlipPageBookCommand,
    E_WordClickBookCommand,
    E_FinishedBookCommand,
    E_StartTimerAnimatedBookCommand,
    E_StopTimerAnimatedBookCommand,
    E_SwitchActivatingViews,
