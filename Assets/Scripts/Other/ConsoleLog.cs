...
namespace Consolation
{
    ...
    {
        //---------------------------
        private float k1 = 2073600f;    //max screen
        private float k2 = 3686400f;     //min screen
        private float k1Value = 30f;   //max screen value
        private float k2Value = 40f;    //min screen value
        private float a;
        private float b;

        private float scrollCount = 2f;
        //---------------------------
        ...
        {
            get; //{ return PlayerPrefs.GetInt("ConsoleLog", 0) == 1; }
            set; //{ PlayerPrefs.SetInt("ConsoleLog", value ? 1 : 0); }
        }
        ...
        private void SetUIElementsSize()
        {
            int size = UISize();
            ...
            GUI.skin.verticalScrollbar.fixedWidth = size * scrollCount;
            GUI.skin.verticalScrollbarThumb.fixedWidth = size * scrollCount;
        }

        private int UISize()
        {
            float realScreeenResolutionDivision = (float)Screen.width * Screen.height;
            GetCoef(k2Value, k1Value, out a, out b);
            return (int)(a * realScreeenResolutionDivision + b);
        }
